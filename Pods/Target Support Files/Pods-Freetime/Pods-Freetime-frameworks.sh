...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/GitHawkRoutes/GitHawkRoutes.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GitHubAPI-iOS/GitHubAPI.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GitHubSession-iOS/GitHubSession.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StringHelpers-iOS/StringHelpers.framework"
